        ...
        <section class="reserva_produto">
            <article class="site">
                <div class="lado_a_lado">
                    <div>
                        <a href="http://localhost/guloseimas_do_olimpophp/public/produtos"><img src="<?php echo BASE_URL . 'uploads/' . $detalheServico['foto_info_produto']; ?>" alt="<?php echo htmlspecialchars($detalheServico['info_alt_foto_produto']); ?>"></a>
                    </div>
