    ...
    <article class="site">
        ...
        <div class="lado_a_lado">
            <?php foreach ($servicos as $servicos_sobre): ?>
                <?php if ($servicos_sobre['status_servico'] === 'Ativo'): ?> <!-- Verifica se o serviço está ativo -->
                    <div class="especialidade_produto">
                        <div class="pd">
                            <img src="/uploads/<?php echo $servicos_sobre['foto_servico']; ?>" alt="<?php echo htmlspecialchars($servicos_sobre['alt_foto_servico']); ?>">
