<section class="minha_historia">
    <article class="site">
        ...
        <div class="lado_a_lado">
            ...
            <div class="foto_quem" style="background-image: url('/uploads/<?php echo htmlspecialchars($minha_historia['foto_galeria'], ENT_QUOTES, 'UTF-8'); ?>');">
