  ...
  <tbody>
    <?php if ($qualidade): ?>
      <tr>
        ...
        <td><img src="/uploads/<?php echo $qualidade['foto_galeria']; ?>" alt="<?php echo $qualidade['alt_foto_galeria']; ?>" class="pg_produto"></td>
        ...
        <td>
          <a href="/galeria/editarG/<?php echo $qualidade['id_galeira']; ?>">
